...
If your application uses less than 6 channels, you are allowed to output from 500µs to 2200µs (cannot go beyond 2200µs due to mechanical limit on servos) on all of them<br>
